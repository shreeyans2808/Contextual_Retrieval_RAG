...
Original file is located at
    https://colab.research.google.com/drive/1FlS2IwB0eopHuIwQ-tqZIG7E9aZr7God
"""

#!pip install langchain faiss-cpu rank_bm25 transformers sentence-transformers huggingface
...
#Retriever
  def __init__(self, document):
    ...
    self.embeddings = CustomSentenceTransformerEmbeddings("sentence-transformers/all-MiniLM-L6-v2")
    self.tokenizer = T5Tokenizer.from_pretrained('t5-base')
    self.llm = T5ForConditionalGeneration.from_pretrained('t5-base')
  ...
  def generate_text(self, prompt: str) -> str:
      inputs = self.tokenizer(prompt, return_tensors='pt', max_length=1000, truncation=True)
      outputs = self.llm.generate(input_ids=inputs.input_ids, max_length=150, num_return_sequences=1)
